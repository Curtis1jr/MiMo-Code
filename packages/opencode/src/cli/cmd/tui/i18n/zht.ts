...
export const dict = {
  ...
  "tui.skill.compose:dev.description": "實作——測試先行、驗證、審查並收尾分支",
  "tui.skill.compose:grill.description": "動手前逐個問題拷問需求，直到達成共識",
  "tui.skill.compose:docs.description": "用單一特性文件記錄設計、任務與交付報告",
  ...
  "tui.skill.compose:dev.slash": "實作執行",
  "tui.skill.compose:grill.slash": "需求拷問",
  "tui.skill.compose:docs.slash": "特性文件",
