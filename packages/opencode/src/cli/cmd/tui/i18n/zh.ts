...
export const dict = {
  ...
  "tui.skill.compose:dev.description": "实现——测试先行、验证、审查并收尾分支",
  "tui.skill.compose:grill.description": "动手前逐个问题拷问需求，直至达成共识",
  "tui.skill.compose:docs.description": "用单一特性文档记录设计、任务与交付报告",
  ...
  "tui.skill.compose:dev.slash": "实现执行",
  "tui.skill.compose:grill.slash": "需求拷问",
  "tui.skill.compose:docs.slash": "特性文档",
